...
public class MessageServiceImpl implements MessageService {
	...
	@Override
	public int newMessCount(ListReadUserByMess vo) {
		return messReadUserMapper.newMessCount(vo);
	}

	@Override
	public void isRead(MessReadUser data) {
		messReadUserMapper.isRead(data);
	}
