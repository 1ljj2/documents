...
public interface ProcessService {
    ...
    /**
     * 根据【流程名称、所属分類】筛选流程列表对象
     */
    PageInfoVo<ListProcessForReviewVo> listForReviewByCondition(ListProcessParam param);
     ...
     * @return
     */
    List<ListIdNameVo> listProcessByName(String processName);
//
//    /**
