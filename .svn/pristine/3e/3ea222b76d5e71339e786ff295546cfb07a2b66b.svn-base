...
//        }
		...
		/**
		 * 不封装swagger swagger的returnType为 method 'uiConfiguration' parameter -1 method
		 * 'swaggerResources' parameter -1 method 'getDocumentation' parameter -1
		 * 或returnTypeName 为 org.springframework.http.ResponseEntity
		 */
		...
		// 返回对象属于自定义 或者 String
		if (obj instanceof CommonResp || obj instanceof CommonRespT || obj instanceof String) {
			return obj;
		}
		// 属于文件类型
