...
//        System.out.println(param+"+++++++++++++++++++++++++");
    ...
    @ApiOperation(value = "筛选出与档案相关的userId对应的课程用户关联表的 courseId")
    @PostMapping("/listArchiveTemOfCourseId")
    public Object listArchiveTemOfCourseId(@RequestBody JSONObject json){
        int userId= json.getInteger("userId");
        //System.out.println("userId======="+userId);
        int allCourseId []=archiveTemplateService.listArchiveTemOfCourseId(userId);
        System.out.println("筛选出与档案相关的userId对应的课程用户关联表的 courseId"+Arrays.toString(allCourseId));
        return allCourseId;
    }
