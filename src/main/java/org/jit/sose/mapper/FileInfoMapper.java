...
public interface FileInfoMapper extends BaseMapper<FileInfo> {
     ...
     * @return
     */
    List<listMyAuditFileVo> listMyAuditFile(listMyAuditFileParam param);
...
//    FileInfo selectByPrimaryKey(Integer id);
    ...
    int shareFile(@Param("shareFiles") List<shareFile> shareFiles);

    int[] selectRoleIdByUserId(@Param("id") Integer id);

    void updateOfWx(FileInfo f);

    void updateByApplyUserId(FileInfo fileInfo);
}