...
public interface UserService extends IService<User> {
     ...
     */
    Integer selectCountByUserName(String name);

    void wxinsert(User wxUser);

    PageInfoVo<UserInfo> selectAuditPeoplePageInfo(int pageNum, int pageSize);

    void auditWxRegisterPeople(int id);
     ...
     * 从excle表格中加入人员
     */
//    void insertFromExcle(ExcelDataVO one);
}
