...
public class FileAuditController {
    ...
    //更据文件id找到审核的流传id
    @PostMapping("/getProcessIdByFileId")
    public int getProcessIdByFileId(@RequestBody Integer fileId) {
        //Integer fileId=json.getInteger("fileId");
        System.out.println("参数传递"+fileId);
       return fileAuditService.getProcessIdByFileId(fileId);
    }
