    ...
    data: function () {
        return {
            ...
            notice: '',// 提醒对象
             ...
             user: {
               id: '',userName: '' ,password: '123456' ,phone: '', age: '',sex: '',
                 code: ''
             },
            ...
            addUsersRoleModal: false,//批量新增用户
    ...
    methods: {
        ...
        checkUserRole() {
            ...
            if (this.user.age === null || this.user.age === '') {
                MessageWarning("请输入年龄！");
                this.flag = 1;
                return;
            }
            if (this.user.code === null || this.user.code === '') {
                MessageWarning("请输入学号！");
                this.flag = 1;
                return;
            }
            ...
            //调动业务端方法
            let url = '/account/member/checkByName';
            CallAjaxPost(url, data, this.findLoginNameSuc);
        },
...
//            		userId:this.userRole.userId,
           ...
           // let url = this.requestPath.userPath + '/insert';
            let url = '/account/member/accountRegister'
        ...
        addUsersRole(){
            ...
            SubmitFileList(this.fileList, this.addMyFileOfUser, "Y")//上传文件
            console.log("上传成功！！！！！！！！！！！！！")
        },

        addMyFileOfUser(data) {
            console.log(data)
            CloseMessageLoading(this.loadingMsg);
            this.canceladdUsersRole()
            this.filter()
        },
