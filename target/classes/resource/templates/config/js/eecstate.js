var vEecstate = new Vue({
    ...
    data: function () {
        return {
            ...
            column: [
                {title: '表', key: 'table', width: 150},
                {title: '表名', key: 'tableName', width: 150},
                {title: '列', key: 'colm', width: 150},
                {title: '列名', key: 'colmName', width: 150},
                {title: '编码', key: 'code', width: 100},
                {title: '编码名', key: 'codeName', width: 150},
    ...
    methods: {
        ...
        filter() {
            ...
            let url = '/config/eecstate/listPageInfo';
        ...
        addEecstate() {
            ...
            let url = '/config/eecstate/insert';
        ...
        editEecstate() {
            ...
            let url = '/config/eecstate/update';
